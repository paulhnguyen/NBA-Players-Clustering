...
```{r, message = F}
all_nbas <- all_nba_teams()
players <- bref_players_stats(seasons = 1950:2020, tables = c("per_game"), include_all_nba = TRUE)
all_nbas_withstats <- all_nbas %>% inner_join(players)
```
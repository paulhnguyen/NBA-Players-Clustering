...
### Looking at All-NBA
When we narrow our observations to just the 15 players that were voted into the all-nba team each season, our first PC is the distinction 
between "Rebounders" (-) and "Shooters" (+). Negative variables 
include trbPerGame, pctTRB, pctDRB, orbPerGame. I would classify our 
second PCA as a battle between "Efficient" (-) and "Not Efficient" (+).
...
and ftaPerGame. Our third PC, I would classify as "Team" (-) vs "Scoring"
